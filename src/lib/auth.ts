...
export async function loginAction(prevState: Record<string, unknown>, formData: FormData): Promise<InitialState> {
    const data = {
...
export async function registerAction(prevState: Record<string, unknown>, formData: FormData): Promise<InitialState> {
    const data = {
